...
function displayTime(time) 
{
  document.getElementById("time").innerHTML = time;
	...
	const determineGreet = hours => document.getElementById("greeting").innerText = `boa ${hours < 12 ? "Manha," : hours < 18 ? "Tarde," : "Noite,"} ${username}!`;
...
const cycleSearchEngines = se => {
  ...
  document.getElementById("search").placeholder = "Procurando com " + curData.placeholder;
